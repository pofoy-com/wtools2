        ...
        <div class="col-12">
            <?php if(!$quickView) { ?>
                ...
                <p>
                    ...
                    <b><a href="<?php echo str_replace(['/wordpress', 'https:/', $http_host], '', $file_url) ?>" target="_blank"><i class="fa fa-external-link-square"></i> <?php echo lng('Open') ?></a></b>
                    &nbsp;
                    <?php
                    // ZIP actions
            ...
            if($is_onlineViewer) {
                ...
                if (in_array($ext, array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))) {
                    echo '<p><img src="' . str_replace(['/wordpress', 'https:/', $http_host], '', $file_url) . '" alt="" class="preview-img"></p>';
                }
            } elseif ($is_audio) {
                // Audio content
                ...
                // Video content
                echo '<div class="preview-video"><video src="' . str_replace(['/wordpress', 'https:/', $http_host], '', $file_url) . '" width="640" height="360" controls preload="metadata"></video></div>';
            } elseif ($is_text) {
                    ...
                    <td>
                        ...
                        <?php
                           if (in_array(strtolower(pathinfo($f, PATHINFO_EXTENSION)), array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))): ?>
                                <?php $imagePreview = '//'. str_replace('/wordpress', '', FM_PATH . '/' . $f); ?>
